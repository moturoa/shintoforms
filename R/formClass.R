...
formClass <- R6::R6Class(
  ...
  public = list(
    ...
    write_new_registration = function(data, user_id, registration_id=NA){
      
      # id of the registration
      reg_id <- ifelse(is.na(registration_id), uuid::UUIDgenerate(), registration_id)
    ...
    edit_registration = function(old_data, new_data, user_id, registration_id=NA){
      
      # id of the registration
      id <- ifelse(is.na( registration_id), old_data[[self$data_columns$id]], registration_id)
